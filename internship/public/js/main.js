 ...
    loader.crossOrigin = "anonymous";
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function showSlide(index) {
            // Remove 'active-slide' class from all images
            images.forEach((img, i) => {
                img.classList.remove("active-slide");
                img.classList.add("hidden-slide"); // Ensure all images are hidden initially
            });
    
            // Add 'active-slide' class to the current image
            images[index].classList.add("active-slide");
            images[index].classList.remove("hidden-slide");
